...
def main() -> None:
    ...
    for row in eval_rows:
        ...
        bm25_candidates = bm25.search(query, k=10, per_doc_limit=10)
        reranked = reranker.rerank(query, bm25_candidates, top_k=10)
        ...
        if top1:
            print(
                ...
                f"bm25_score={top1.get('score', 0):.4f} | rerank_score={top1.get('rerank_score', 0):.4f}"
            )
        else:
            print("Top1 : None")
